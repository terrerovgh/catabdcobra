...
export const es: Dict = {
  ...
  home: {
    ...
    workTitle: 'Tinta reciente',
    workSub: 'Un vistazo al portafolio — abre la galería para verlo completo.',
    workCta: 'Abrir galería completa',
  ...
  artists: {
    ...
    seeWork: 'Ver su trabajo en la galería',
  },
  gallery: {
    title: 'Galería',
    sub: 'Filtra por estilo, artista o diseño — recién hecho vs curado aguanta años.',
    filterStyle: 'Estilo',
    ...
    fresh: 'Recién hecho',
    healed: 'Curado',
    emptyTitle: 'Nada en este filtro',
    emptyBody:
